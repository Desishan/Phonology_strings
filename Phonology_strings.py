...
#add case with multiple 'to' results
#maybe regex | for either or could be helpful?
...
def sanskrit_to_pali(wordlist):
    ...
    mutation(['ʃ', 'ʂ'], 's', wordlist, description='place-merger of sibilants (this has a name lol)')
...
starting_wordlist = phono_data.Pair2.list1
target_wordlist = phono_data.Pair2.list2
